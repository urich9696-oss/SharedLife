...
export const ENTITY_TYPE_META: Record<EntityType, EntityTypeMeta> = {
  ...
  household: {
    ...
    label: 'Notiz',
    labelPlural: 'Notizen',
    description: 'Legacy-Eintrag (Zuhause-Modul entfernt)',
    creatable: false,
    planningSegment: false,
    statuses: ['active', 'completed', 'archived'],
    statusLabels: statusLabelsDe,
  ...
  leisure: {
    ...
    description: 'Idee für ein gemeinsames Date',
    creatable: true,
    planningSegment: false,
    statuses: ['draft', 'active', 'completed', 'archived'],
...
/** Primäre Plus-Aktionen (V4 Masterprompt) */
export const PRIMARY_CREATE_ACTIONS = [
  {
    key: 'moment',
    label: 'Moment',
    description: 'Erinnerung mit Foto festhalten',
    kind: 'route' as const,
  ...
  },
  {
    key: 'event',
    label: 'Termin',
    description: 'Datum im Kalender planen',
  ...
  },
  {
    key: 'shopping-item',
    label: 'Einkauf',
    description: 'Artikel zur Liste hinzufügen',
    kind: 'route' as const,
  ...
  },
  {
    key: 'expense',
    label: 'Ausgabe',
    description: 'Gemeinsame Kosten erfassen',
    kind: 'entity' as const,
    entityType: 'expense' as EntityType,
    contexts: ['default'] as const,
  },
  {
    key: 'recipe',
    label: 'Rezept',
    description: 'Gericht fürs Kochbuch',
    kind: 'entity' as const,
    entityType: 'recipe' as EntityType,
    contexts: ['default'] as const,
  },
  {
    key: 'wish',
    label: 'Wunsch',
    description: 'Geschenkidee merken',
    kind: 'entity' as const,
    entityType: 'wish' as EntityType,
    contexts: ['default'] as const,
  },
  {
    key: 'leisure',
    ...
    description: 'Idee für ein gemeinsames Date',
    kind: 'entity' as const,
    entityType: 'leisure' as EntityType,
    contexts: ['default'] as const,
  },
  {
    key: 'trip',
    ...
    kind: 'entity' as const,
    entityType: 'trip' as EntityType,
    contexts: ['vorhaben', 'default'] as const,
  },
  {
    key: 'goal',
    label: 'Ziel',
    description: 'Gemeinsamen Fortschritt tracken',
    kind: 'entity' as const,
  ...
  },
  {
    key: 'date',
    label: 'Date',
    description: 'Romantischen Abend planen',
    kind: 'entity' as const,
    entityType: 'date' as EntityType,
    contexts: ['vorhaben', 'default'] as const,
  },
] as const
